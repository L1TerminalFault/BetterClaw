...
export default function EmptyChat() {
  ...
  return (
    ...
    <div className="flex flex-col gap-10 -translate-y-50 items-center justify-center pb-20">
      <div className="p-8 lg:text-5xl text-3xl text-center">{currentGreeting}</div>
